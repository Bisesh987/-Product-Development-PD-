...
if(isset($_POST['changePassword'])){
    ...
    if (strlen($_POST['password']) < 8) {
        ...
        if ($_POST['password'] != $_POST['confirmPassword']) {
            ...
            $updatePassword = "UPDATE login SET password = '$password' WHERE email = '$email'";
            $updatePass = mysqli_query($data, $updatePassword) or die("Query Failed");
            session_unset($email);
            session_destroy();
               ...
               <div class="col-md-5 p-5 bg-white full-height">
                  <div class="login-main-left">
                     <div class="text-center mb-5 login-main-left-header pt-4">
                        ...
                        <h5 class="mt-3 mb-3">Please Enter New Password</h5>
                     ...
                     <form action="newpassword.php" method="POST" autocomplete="off">
                        ...
                        <input type="submit" class='btn btn-success border-none' name="changePassword" value="Save">
                    </form>
                  </div>
               </div>
               <div class="col-md-7">
