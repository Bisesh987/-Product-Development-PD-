            ...
            <li class="nav-item channel-sidebar-list">
               ...
               <ul>
                  <li>
                     ...
                     <img class="img-fluid" alt="" src="img/s1.png"> FootBall 
                     </a>
                  </li>
                  <li>
                     <a href="subscriptions.php">
                     <img class="img-fluid" alt="" src="img/s2.png"> Swimming  <span class="badge badge-warning">2</span>
                     </a>
                  </li>
                  <li>
                     <a href="subscriptions.php">
                     <img class="img-fluid" alt="" src="img/s3.png"> Shooting  
                     </a>
                  </li>
                  <li>
                     <a href="subscriptions.php">
         ...
         <div id="content-wrapper">
            <div class="container-fluid upload-details">
               <div class="row">
                ...
                <form method="post" action="userupdate.php?username=<?php echo $username; ?>">
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="form-group">
                           <label class="control-label">User Name <span class="required">*</span></label>
                           <input class="form-control border-form-control" value="<?php echo $_SESSION['username'];?>" placeholder="Enter Your First Name" type="text" readonly>
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="form-group">
                           <label class="control-label">User Type<span class="required">*</span></label>
                           <input type="text" name="usertype" value="<?php echo $row['usertype']; ?>" class="form-control" placeholder="usertype" readonly>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input type="number" name="contact" value="<?php echo $row['contact']; ?>" class="form-control" placeholder="Contact">
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-sm-6">
                      <div class="form-group">
                           ...
                           <select type="text" name="gender" value="<?php echo $row['gender']; ?>" class="form-control" placeholder="Gender">
                     ...
                     <div class="col-sm-6">
                         <div class="form-group">
                           ...
                           <select type="country" name="country" value="<?php echo $row['country']; ?>"class="form-control" placeholder="Country" required>
                  ...
                  <div class="row">
                     <div class="col-sm-12 text-right">
                        ...
                        <button type="submit" name="submit" value="update" class="btn btn-success border-none">Save Changes</button>
                     </div>
                  </div>
               </form>
            </div>
