...
$db="funolympic";
   ...
   $id=$_GET['id'];
   $query=mysqli_query($data,"select * from `game`");
            ...
            <div class="row no-gutters">
               <div class="col-md-5 p-5 bg-white full-height">
                  <div class="login-main-left">
                     ...
                     <form method="post" action="gameupdate.php?id=<?php echo $id; ?>">
                        <div class="form-group">
                           <label>Games</label>
                           <input type="text" name="games" value="<?php echo $row['games']; ?>" class="form-control" placeholder="Enter game">
                        </div>
                        <div class="form-group">
                           <label>Location</label>
                           <select type="location" name="location" value="<?php echo $row['location']; ?>"class="form-control" placeholder="location" required>
