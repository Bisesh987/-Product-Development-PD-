                  ...
                  <div class="login-main-left">
                     ...
                     <form method="post" action="update.php?id=<?php echo $id; ?>">
                        ...
                        <div class="form-group">
                           ...
                           <select type="usertype" name="usertype" class="form-control" value="<?php echo $row['usertype']; ?>" placeholder="usertype" >
                        ...
                        <div class="form-group">
                           <label>Gender</label>
                           <select type="gender" name="gender" value="<?php echo $row['gender']; ?>"class="form-control" placeholder="Gender" required>
