...
<head>
   ...
   <body id="page-top">
      <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <marquee><h1>Hello Admin, <?php echo $_SESSION["username"] ?></h1></marquee>    
         <!-- Navbar Search -->
         ...
         <div id="content-wrapper">
            <div class="container-fluid upload-details">
               <div class="row">
                ...
                <form method="post" action="adminupdate.php?username=<?php echo $username; ?>">
                  <div class="row">
                     <div class="col-sm-6">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <select type="text" name="usertype" value="<?php echo $row['usertype']; ?>" class="form-control" placeholder="usertype">
