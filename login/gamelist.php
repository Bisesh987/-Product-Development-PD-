           ...
           *{  
           ...
           table tr:nth-child(odd){  
                background-color: #797676;  
                           ...
                           <div class="container">  
                           	<h5>All Games</h5><a class='btn btn-success border-none' href='addgame.php'>+Add Games</a>
						      <table border="1">  
						           <tr>  
						                      <th>games</th>  
                                  <th>location</th>
						                     ...
						                     while($row=mysqli_fetch_assoc($result)){  
						                          echo "  
						                              <tr>  
                                                       ...
                                                       <td>".$row['date']."</td>  
                                                       <td>
                                                        <a class='btn btn-success border-none' href='gameedit.php?id=$row[id]'>Edit</a>
                                                        <a class='btn btn-danger border-none' href='gamedelete.php?id=$row[id]'>Delete</a>
                                                        </td>
						                                           </tr> 
						                          ";  
						                     }  
