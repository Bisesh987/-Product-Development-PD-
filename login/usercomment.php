						                     ...
						                     while($row=mysqli_fetch_assoc($result)){  
						                          echo "  
						                              <tr>  
						                                           ...
						                                           <td>".$row['comment']."</td>  
                                                       <td>
                                                        <a class='btn btn-success border-none' href='commentupdate.php?id=$row[id]'>Edit</a>
                                                        <a class='btn btn-danger border-none' href='deletecomment.php?id=$row[id]'>Block</a>
                                                        </td>
						                                           </tr> 
						                          ";  
						                     }  
