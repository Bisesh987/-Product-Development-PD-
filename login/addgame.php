...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
   ...
   $date = $_POST["date"];
         ...
         $sql = "INSERT INTO game(games, location, date) VALUES('$games','$location','$date')";
               ...
               <div class="col-md-5 p-5 bg-white full-height">
                  <div class="login-main-left">
                     <div class="text-center mb-5 login-main-left-header pt-1">
                        ...
                        <h5 class="mt-1 mb-1">Please Add Games</h5>
                        <p>Please insert valid data</p>
                     </div>
                     <form method="post">
                        <div class="form-group">
                           <label>games</label>
                           <input type="text" name="games" class="form-control" placeholder="Enter Game Title" required>
                        </div>
                        <div class="form-group">
                           <label>location</label>
                           <select type="location" name="location" class="form-control" placeholder="location" required>
                        ...
                        <div class="mt-4">
                           <button type="submit" name="submit" value="signup" class="btn btn-outline-primary btn-block btn-lg">Add</button>
                        </div>
                     </form>
                  </div>
               </div>
